...
export function SideBar(){
    ...
    return(
        ...
        <Menu>
          ...
          <ul>
            <li><NavLinkButton href='/home' active={router.asPath === '/home'}><ChartLineUp size={24}/>Inicio</NavLinkButton></li>
         ...
         {!user ? <Button href="/"> Fazer login <SignIn size={20}/></Button> : <Button href="/home" onClick={()=> signOut()}><Avatar size="sm" alt={`Perfil de ${user?.name!}`} src={user?.avatar_url!}/>{user?.name.split(' ')[0]}<SignOut color="#F75A68" size={20}/></Button> }               
